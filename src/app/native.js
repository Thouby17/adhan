...
(function (root) {
  ...
  root.AdhanNative = {
    ...
    coranCast: function (url, titre, numero) { return appel("coranCast", { url: url, titre: titre || "", numero: numero || 0 }); },
    coranCastVersets: function (urls, numero) { return appel("coranCastVersets", { urls: urls, numero: numero || 0 }); },
    coranCastSeek: function (sec, absolu) { return appel("coranCastSeek", { sec: sec, absolu: !!absolu }); },
    coranCastSaut: function (delta) { return appel("coranCastSaut", { delta: delta }); },
